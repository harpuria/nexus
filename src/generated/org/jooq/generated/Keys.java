...
public class Keys {
    ...
    public static final UniqueKey<MultipleProductRecord> MULTIPLE_PRODUCT_PKEY = Internal.createUniqueKey(JMultipleProduct.MULTIPLE_PRODUCT, DSL.name("MULTIPLE_PRODUCT_pkey"), new TableField[] { JMultipleProduct.MULTIPLE_PRODUCT.MULTIPLE_PRODUCT_ID }, true);
    ...
    public static final UniqueKey<SingleProductRecord> SINGLE_PRODUCT_PKEY = Internal.createUniqueKey(JSingleProduct.SINGLE_PRODUCT, DSL.name("SINGLE_PRODUCT_pkey"), new TableField[] { JSingleProduct.SINGLE_PRODUCT.SINGLE_PRODUCT_ID }, true);
    ...
    public static final ForeignKey<MultipleProductRecord, CurrencyRecord> MULTIPLE_PRODUCT__MULTIPLE_PRODUCT_CURRENCY_ID_FOREIGN = Internal.createForeignKey(JMultipleProduct.MULTIPLE_PRODUCT, DSL.name("multiple_product_currency_id_foreign"), new TableField[] { JMultipleProduct.MULTIPLE_PRODUCT.CURRENCY_ID }, Keys.CURRENCY_PKEY, new TableField[] { JCurrency.CURRENCY.CURRENCY_ID }, true);
    public static final ForeignKey<MultipleProductRecord, ProductRecord> MULTIPLE_PRODUCT__MULTIPLE_PRODUCT_PRODUCT_ID_FOREIGN = Internal.createForeignKey(JMultipleProduct.MULTIPLE_PRODUCT, DSL.name("multiple_product_product_id_foreign"), new TableField[] { JMultipleProduct.MULTIPLE_PRODUCT.PRODUCT_ID }, Keys.PRODUCT_PKEY, new TableField[] { JProduct.PRODUCT.PRODUCT_ID }, true);
    ...
    public static final ForeignKey<SingleProductRecord, CurrencyRecord> SINGLE_PRODUCT__SINGLE_PRODUCT_CURRENCY_ID_FOREIGN = Internal.createForeignKey(JSingleProduct.SINGLE_PRODUCT, DSL.name("single_product_currency_id_foreign"), new TableField[] { JSingleProduct.SINGLE_PRODUCT.CURRENCY_ID }, Keys.CURRENCY_PKEY, new TableField[] { JCurrency.CURRENCY.CURRENCY_ID }, true);
    public static final ForeignKey<SingleProductRecord, ProductRecord> SINGLE_PRODUCT__SINGLE_PRODUCT_PRODUCT_ID_FOREIGN = Internal.createForeignKey(JSingleProduct.SINGLE_PRODUCT, DSL.name("single_product_product_id_foreign"), new TableField[] { JSingleProduct.SINGLE_PRODUCT.PRODUCT_ID }, Keys.PRODUCT_PKEY, new TableField[] { JProduct.PRODUCT.PRODUCT_ID }, true);
