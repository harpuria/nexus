...
public class Item implements Serializable {
    ...
    /**
     * Getter for <code>nexus.ITEM.GAME_ID</code>. 게임 ID (FK)
     */
    ...
    /**
     * Setter for <code>nexus.ITEM.GAME_ID</code>. 게임 ID (FK)
     */
    public Item setGameId(Integer gameId) {
        this.gameId = gameId;
        return this;
    }

    /**
     * Getter for <code>nexus.ITEM.ITEM_CODE</code>. 게임 내 유니크 코드(운영/클라 식별용)
     */
    ...
    /**
     * Setter for <code>nexus.ITEM.ITEM_CODE</code>. 게임 내 유니크 코드(운영/클라 식별용)
     */
    ...
    /**
     * Getter for <code>nexus.ITEM.NAME</code>. 아이템 이름
     */
    ...
    /**
     * Setter for <code>nexus.ITEM.NAME</code>. 아이템 이름
     */
    ...
    /**
     * Getter for <code>nexus.ITEM.DESC</code>. 아이템 설명
     */
    ...
    /**
     * Setter for <code>nexus.ITEM.DESC</code>. 아이템 설명
     */
    ...
    /**
     * Getter for <code>nexus.ITEM.IS_STACKABLE</code>. 스택형 여부 (Y:수량형, N:인스턴스형)
     */
    ...
    /**
     * Setter for <code>nexus.ITEM.IS_STACKABLE</code>. 스택형 여부 (Y:수량형, N:인스턴스형)
     */
    public Item setIsStackable(String isStackable) {
        this.isStackable = isStackable;
        return this;
    }

    /**
     * Getter for <code>nexus.ITEM.DEFAULT_STACK</code>. 기본 수량(스택형일 때)
     */
    ...
    /**
     * Setter for <code>nexus.ITEM.DEFAULT_STACK</code>. 기본 수량(스택형일 때)
     */
    public Item setDefaultStack(Long defaultStack) {
        this.defaultStack = defaultStack;
        return this;
    }

    /**
     * Getter for <code>nexus.ITEM.MAX_STACK</code>. 최대 누적 가능 수량(스택형일 때)
     */
    ...
    /**
     * Setter for <code>nexus.ITEM.MAX_STACK</code>. 최대 누적 가능 수량(스택형일 때)
     */
    public Item setMaxStack(Long maxStack) {
        this.maxStack = maxStack;
        return this;
    }

    /**
     * Getter for <code>nexus.ITEM.RARITY</code>. 등급(선택)
     */
    ...
    /**
     * Setter for <code>nexus.ITEM.RARITY</code>. 등급(선택)
     */
     ...
     */
    public Item setCreatedAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    public Item setCreatedBy(String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    public Item setUpdatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     */
    public Item setUpdatedBy(String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
     ...
     */
    public Item setIsDel(String isDel) {
        this.isDel = isDel;
        return this;
    }
