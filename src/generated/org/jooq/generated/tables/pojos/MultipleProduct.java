...
public class MultipleProduct implements Serializable {
    ...
    public MultipleProduct(MultipleProduct value) {
        this.multipleProductId = value.multipleProductId;
    ...
    public MultipleProduct(
        ...
        this.multipleProductId = multipleProductId;
     ...
     * 아이디 (PK)
     */
    public MultipleProduct setMultipleProductId(Integer multipleProductId) {
        this.multipleProductId = multipleProductId;
        return this;
    }
     ...
     */
    public MultipleProduct setProductId(Integer productId) {
        this.productId = productId;
        return this;
    }
     ...
     * (FK)
     */
    public MultipleProduct setCurrencyId(Integer currencyId) {
        this.currencyId = currencyId;
        return this;
    }
     ...
     */
    public MultipleProduct setAmount(Long amount) {
        this.amount = amount;
        return this;
    }
     ...
     */
    public MultipleProduct setCreatedAt(OffsetDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    public MultipleProduct setCreatedBy(String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    public MultipleProduct setUpdatedAt(OffsetDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     */
    public MultipleProduct setUpdatedBy(String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
     ...
     */
    public MultipleProduct setIsDel(String isDel) {
        this.isDel = isDel;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final MultipleProduct other = (MultipleProduct) obj;
        if (this.multipleProductId == null) {
            if (other.multipleProductId != null)
                return false;
        }
        else if (!this.multipleProductId.equals(other.multipleProductId))
            return false;
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((this.multipleProductId == null) ? 0 : this.multipleProductId.hashCode());
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("MultipleProduct (");

        sb.append(multipleProductId);
